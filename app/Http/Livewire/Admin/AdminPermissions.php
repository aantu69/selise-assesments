...
class AdminPermissions extends Component
{
    ...
    {
        return view('livewire.admin.admin-permissions', [
    ...
    {
        $this->authorizeRoleOrPermission('Permission Delet');
    ...
    {
        $this->authorizeRoleOrPermission('Permission Create');
