...
<body class="sidebar-mini layout-fixed control-sidebar-slide-open sidebar-collapse">
    ...
    <script>
        ...
        window.addEventListener('swal:confirmSave', event => {
            var title = event.detail.title ?? 'Are you sure want to save these information?';
            var text = event.detail.text ?? "You won't be able to change this!";
            var type = event.detail.type ?? 'warning';
            swal({
                    title: title,
                    text: text,
