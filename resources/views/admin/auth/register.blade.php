    ...
    <div class="login-container sign-up-mode">
        <div class="forms-container">
            <div class="signin-signup">
                <form method="POST" action="{{ route('admin.register') }}" class="sign-up-form">
                    @csrf
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                <div class="content">
                    ...
                    <a class="btn transparent" href="{{ route('admin.register') }}">{{ __('Sign up') }}</a>
                </div>
            ...
            <div class="panel right-panel">
                <div class="content">
                    ...
                    <a class="btn transparent" href="{{ route('admin.login') }}">{{ __('Sign in') }}</a>
                </div>
